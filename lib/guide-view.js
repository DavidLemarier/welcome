...
export default class GuideView {
          ...
          <section className='welcome-panel'>
            ...
            <details className='welcome-card' {...this.getSectionProps('project')}>
              ...
              <div className='welcome-detail'>
                <p>
                  <img className='welcome-img' src='soldat://welcome/assets/project.svg' />
                </p>
                <p>
                  In Soldat you can open individual files or a whole folder as a
            ...
            <details className='welcome-card' {...this.getSectionProps('git')}>
              ...
              <div className='welcome-detail'>
                <p>
                  <img className='welcome-img' src='soldat://welcome/assets/package.svg' />
                </p>
                <p>
            ...
            <details className='welcome-card' {...this.getSectionProps('packages')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  One of the best things about Soldat is the package ecosystem.
            ...
            <details className='welcome-card' {...this.getSectionProps('themes')}>
              ...
              <div className='welcome-detail'>
                <p>
                  <img className='welcome-img' src='soldat://welcome/assets/theme.svg' />
                </p>
                <p>
                  Soldat comes with preinstalled themes. Let's try a few.
                </p>
                <p>
                ...
                <p>
                  You can also install themes created by the Soldat community. To
            ...
            <details className='welcome-card' {...this.getSectionProps('styling')}>
              ...
              <div className='welcome-detail'>
                <p>
                  <img className='welcome-img' src='soldat://welcome/assets/code.svg' />
                </p>
                <p>
            ...
            <details className='welcome-card' {...this.getSectionProps('snippets')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  Soldat snippets allow you to enter a simple prefix in the editor
            ...
            <details className='welcome-card' {...this.getSectionProps('shortcuts')}>
              ...
              <div className='welcome-detail'>
                <p>
                  <img className='welcome-img' src='soldat://welcome/assets/shortcut.svg' />
                </p>
                <p>
                  ...
                  Soldat command. It's a good way to learn more shortcuts. Yes,
                  you can try it now!
                </p>
                <p>
  ...
  didClickProjectButton () {
    ...
    soldat.commands.dispatch(soldat.views.getView(soldat.workspace), 'application:open')
  }

  didClickGitButton () {
    this.props.reporterProxy.sendEvent('clicked-git-cta')
    soldat.commands.dispatch(soldat.views.getView(soldat.workspace), 'github:toggle-git-tab')
  }

  didClickGitHubButton () {
    this.props.reporterProxy.sendEvent('clicked-github-cta')
    soldat.commands.dispatch(soldat.views.getView(soldat.workspace), 'github:toggle-github-tab')
  }

  didClickPackagesButton () {
    this.props.reporterProxy.sendEvent('clicked-packages-cta')
    soldat.workspace.open('soldat://config/install', {split: 'left'})
  }

  didClickThemesButton () {
    this.props.reporterProxy.sendEvent('clicked-themes-cta')
    soldat.workspace.open('soldat://config/themes', {split: 'left'})
  }

  didClickStylingButton () {
    this.props.reporterProxy.sendEvent('clicked-styling-cta')
    soldat.workspace.open('soldat://.soldat/stylesheet', {split: 'left'})
  }

  didClickInitScriptButton () {
    this.props.reporterProxy.sendEvent('clicked-init-script-cta')
    soldat.workspace.open('soldat://.soldat/init-script', {split: 'left'})
  }

  didClickSnippetsButton () {
    this.props.reporterProxy.sendEvent('clicked-snippets-cta')
    soldat.workspace.open('soldat://.soldat/snippets', {split: 'left'})
  }
