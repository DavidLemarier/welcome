...
export default class ConsentView {
      ...
      <div className='welcome'>
        <div className='welcome-container'>
          <div className='header'>
            <a title='soldat.io' href='https://soldat.io/'>
          ...
          <div className='welcome-consent'>
            <p>To help improve Soldat, you can anonymously send usage stats to the team. The resulting data plays a key role in deciding what to focus on.</p>
            <p className='welcome-note'>The data we send is minimal. Broadly, we send things like startup time, session time, and exceptions — never code or paths. See the <a onclick={this.openMetricsPackage.bind(this)}>soldat/metrics package</a> for details on what data is sent.</p>
            ...
            <div className='welcome-consent-choices'>
              ...
              <div>
                <button className='btn btn-primary' onclick={this.consent.bind(this)}>Yes, I want to help improve Soldat</button>
                <p className='welcome-note'>You are helping us assess Soldat's performance and understand usage patterns.</p>
              </div>
            </div>
          </div>
  ...
  consent () {
    soldat.config.set('core.telemetryConsent', 'limited')
    soldat.workspace.closeActivePaneItemOrEmptyPaneOrWindow()
  }
  ...
  openMetricsPackage () {
    soldat.workspace.open('soldat://config/packages/metrics')
  }
