...
export default class WelcomeView {
  ...
  didChangeShowOnStartup () {
    soldat.config.set('welcome.showOnStartup', this.checked)
  }
      ...
      <div className='welcome'>
        <div className='welcome-container'>
          ...
          <section className='welcome-panel'>
            ...
            <ul>
              <li>The <a href='https://www.soldat.io/docs' dataset={{event: 'soldat-docs'}}>Soldat docs</a> for Guides and the API reference.</li>
              <li>The Soldat forum at <a href='http://discuss.soldat.io' dataset={{event: 'discuss'}}>discuss.soldat.io</a></li>
              <li>The <a href='https://github.com/soldat' dataset={{event: 'soldat-org'}}>Soldat org</a>. This is where all GitHub-created Soldat packages can be found.</li>
            </ul>
          </section>

          <section className='welcome-panel'>
            <label>
              <input className='input-checkbox' type='checkbox' checked={soldat.config.get('welcome.showOnStartup')} onchange={this.didChangeShowOnStartup} />
              Show Welcome Guide when opening Soldat
            </label>
          </section>

          <footer className='welcome-footer'>
            <a href='https://soldat.io/' dataset={{event: 'footer-soldat-io'}}>soldat.io</a> <span className='text-subtle'>×</span> <a className='icon icon-octoface' href='https://github.com/' dataset={{event: 'footer-octocat'}} />
          </footer>
        </div>
      </div>
    )
